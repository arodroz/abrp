...
ABRP-native ships or downloads data from the sources below. This file is the canonical
attribution list; the in-app "Data sources" screen renders the same entries (ADR 0005).

| Data | Provider | Licence | Verified |
|---|---|---|---|
...
| Elevation | Copernicus DEM GLO-30 © DLR e.V. 2010-2014 and © Airbus Defence and Space GmbH 2014-2018, provided under COPERNICUS by the European Union and ESA | Copernicus DEM licence (attribution required) | pending |
| Road network / Region Packs | © OpenStreetMap contributors | ODbL 1.0 | pending |
| Basemap tiles / Map Packs | Protomaps (OpenStreetMap data) | ODbL 1.0 (data), Protomaps builds: BSD-3 / CC0 style | pending |
